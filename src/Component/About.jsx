    ...
    <>
      ...
      <div className='about-container'>
        <div className='about-your'>
          <h2>Who We Are</h2>
          <p>
            SK Enterprises was founded in 2018 with a simple mission: to provide reliable,
            efficient, and affordable home repair and installation services. What started as a
            small local business has grown into a trusted name in home maintenance. For any
            assistance or queries, our customer support representative, Gopal Mhasal, is always
            ready to help.
          </p>
        </div>
        <div className='about-image'>
          <img src='/image AC.png' className='images' alt="AC Service" />
        </div>
      </div>
      ...
      <div className='about-buttons'>
        ...
        <button onClick={() => handleClick('value')}>Our Values</button>
      </div>
      ...
      <div className='mission-container'>
        ...
        <div className='about-miision-item'>
          <div className='mission-item-col'>
            <div className='about-mission-data'>
              <i className='about-mission-icon'>
                <img src='/swift.png' alt='Swift icon' />
              </i>
              <h3>Swift</h3>
              <p>Quick Repair</p>
              <p>Immediate Response</p>
          ...
          <div className='mission-item-col'>
            <div className='about-mission-data'>
              <i className='about-mission-icon'>
                <img src='/Professional.png' alt='Professional icon' />
              </i>
              <h3>Professional</h3>
              <p>Professional service</p>
              <p>Professional techniques</p>
          ...
          <div className='mission-item-col' id='reliable'>
            <div className='about-mission-data'>
              <i className='about-mission-icon'>
                <img src='/Reliable.png' alt='Reliable icon' />
              </i>
              <h3>Reliable</h3>
              <p>Original parts</p>
              <p>High quality</p>
          ...
          <div className='mission-item-col' id='valuable'>
            <div className='about-mission-data'>
              <i className='about-mission-icon'>
                <img src='/valuable.png' alt='Valuable icon' />
              </i>
              <h3>Valuable</h3>
              <p>Satisfying</p>
              <p>Humanistic</p>
        ...
        <section className='team-section'>
          ...
          <div className='team-container'>
            <div className='team-member'>
              <div className='team-text'>
                <p>
                  With years of experience and a commitment to quality, SK Enterprises has earned the trust
                  of hundreds of satisfied customers. We provide reliable and efficient AC services,
                  ensuring comfort and peace of mind for every client.
                </p>
              </div>
              <h2>Trusted</h2>
            </div>
            ...
            <div className='team-member'>
              <div className='team-text'>
                <p>
                  Our team of certified and skilled technicians is trained to handle all types of AC
                  systems. From minor repairs to complete servicing, we ensure every job is done with
                  precision and care.
                </p>
              </div>
              <h2>Expert Technicians</h2>
            ...
            <div className='team-member'>
              <div className='team-text'>
                <p>
                  We value your time and comfort. That's why SK Enterprises offers prompt service and quick
                  response times, ensuring your AC is back up and running when you need it the most.
                </p>
              </div>
              <h2>Fast & Reliable Service</h2>
            </div>
